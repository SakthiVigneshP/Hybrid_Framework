...
public class Seller_Functions {
	...
	public Seller_Functions(RemoteWebDriver driver, ExtentTest logger, String Test_Start_Time, String TCName,
		...
		buyerObj = new Buyer_Functions(driver,logger,Test_Start_Time, TCName, testDataCollection);
		wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		
		this.logger = logger;
		this.Test_Start_Time = Test_Start_Time;
		testCaseFullName = TCName;
