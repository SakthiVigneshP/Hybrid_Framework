...
public class TestNGRun_Thread1 {
  ...
  public void afterMethod() {
	  try {
		  System.out.println("in after method task kill drivers/browsers:Thread1");
  ...
  public ArrayList<String> executeQuery(String strQuery){
	  ...
	  testDataName = config.getString("DATASHEET_NAME_THREAD1");
	  ArrayList<String> testDetails = new ArrayList<String>();
