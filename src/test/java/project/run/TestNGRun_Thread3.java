...
public class TestNGRun_Thread3 {
  ...
  public void afterMethod() {
	  try {
		  System.out.println("in after method task kill drivers/browsers: Thread 3");
  ...
  public ArrayList<String> executeQuery(String strQuery){
	  ...
	  testDataName = config.getString("DATASHEET_NAME_THREAD3");
	  ArrayList<String> testDetails = new ArrayList<String>();
