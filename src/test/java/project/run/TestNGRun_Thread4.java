...
public class TestNGRun_Thread4 {
  ...
  public void afterMethod() {
	  try {
		  System.out.println("in after method task kill drivers/browsers:Thread 4");
  ...
  public ArrayList<String> executeQuery(String strQuery){
	  ...
	  testDataName = config.getString("DATASHEET_NAME_THREAD4");
	  ArrayList<String> testDetails = new ArrayList<String>();
